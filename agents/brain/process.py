...
import agents.brain.tools as tools
import agents.brain.prompt as prompt
...
class BrainAgent:
    ...
    def run(self, query: str, user_input: str, task_type: str="商单图文") -> str:
        ...
        for turn in range(self.max_turns):
            ...
            os.makedirs(f"{self.save_dir}/brain_log", exist_ok=True)
            with open(f"{self.save_dir}/brain_log/{filename}_{turn}.json", "w") as f:
